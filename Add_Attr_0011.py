...
# code:
# import Add_Attr_0011
# import imp
# imp.reload(Add_Attr_0011)
# Add_Attr_0011.GUI() 
# ---------------------------------------------------------------
# I hope you find this useful. Maya 2023 and all previous Maya 
...
def GUI():
	...
	# main tab
	scroll_tab = cmds.scrollLayout(p=main_tab, w=290, h=490)
	...
	help_text = 'Add Attribute Tool \n\nVersion: 1.10 \n\nAuthor: Aashi Shukla \n\n-----------------------------------------\n\nAn easy-to-use script for adding your custom attributes with a variety of presets to choose from and the option to lock, hide and show attributes without having to go through the entire channel box again and again. \n\n(Maya 2023 and all previous versions supported)'
